        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('excerpt', null, array('placeholder' => 'Excerpt','class' => 'form-control','style'=>'height:50px')) !!}
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('status', array('1' => 'Active', '0' => 'In-Active'), 'active',array('class' => 'form-control')) !!}
                </div>
            </div>
